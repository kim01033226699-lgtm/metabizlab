...
const CONCERN_DETAILS = [
  {
    title: '매출은 꾸준한데 왜 남는 돈이 적은지, 한 번쯤 생각해보신 적 있으신가요?',
  ...
  {
    title: '세금이나 고정비를 줄일 수 있는 방법이 궁금하신가요?',
  ...
  {
    title: '사업 운영 중 발생할 수 있는 위험에 대해 생각해 보신 적 있으신가요?',
  ...
  {
    title: '창업, 마케팅, 플랫폼을 어떻게 시작해야 할지 궁금하신가요?',
...
function PartnersSlider() {
  ...
  const partners = [
    ...
    { name: '영필름', role: '영상 제작', person: '이영재 감독', link: 'https://www.instagram.com/young_film_studio/' },
